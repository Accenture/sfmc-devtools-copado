...
var CONFIG = {
  ...
  destinationBranch: process.env.toBranch,
  fileSelectionFileName: "Copado Deploy changes",
  fileSelectionSalesforceId: process.env.metadata_file,
  fileUpdatedSelectionSfid: null,
  git_depth: 100,
  merge_strategy: process.env.merge_strategy,
  promotionBranch: process.env.promotionBranch,
  promotionName: process.env.promotionName,
